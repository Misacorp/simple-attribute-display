...
class Simple_Attribute_Display_Settings {

	/**
	 * The single instance of Simple_Attribute_Display_Settings.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function add_menu_item () {
		$page = add_options_page( __( 'Plugin Settings', 'simple-attribute-display' ) , __( 'Plugin Settings', 'simple-attribute-display' ) , 'manage_options' , $this->parent->_token . '_settings' ,  array( $this, 'settings_page' ) );
	...
	public function add_settings_link ( $links ) {
		$settings_link = '<a href="options-general.php?page=' . $this->parent->_token . '_settings">' . __( 'Settings', 'simple-attribute-display' ) . '</a>';
	...
	public function settings_page () {
		...
		$html = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			$html .= '<h2>' . __( 'Plugin Settings' , 'simple-attribute-display' ) . '</h2>' . "\n";
			...
			$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
				...
				$html .= '<p class="submit">' . "\n";
					...
					$html .= '<input name="Submit" type="submit" class="button-primary" value="' . esc_attr( __( 'Save Settings' , 'simple-attribute-display' ) ) . '" />' . "\n";
				$html .= '</p>' . "\n";
			$html .= '</form>' . "\n";
		$html .= '</div>' . "\n";
	...
	/**
	 * Main Simple_Attribute_Display_Settings Instance
	 *
	 * Ensures only one instance of Simple_Attribute_Display_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Simple_Attribute_Display()
	 * @return Main Simple_Attribute_Display_Settings instance
	 */
