...
Installing "Simple Attribute Display" can be done either by searching for "Simple Attribute Display" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
